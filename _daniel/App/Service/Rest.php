...
class App_Service_Rest 
{
    ...
    public function getBuyBackItems()
    {
        ...
        return $this->doRequest('WS_GetBuyBackBookPrices');
    }
    ...
    public function changeParentDetails($data)
    {
        // http://41.86.98.148/bookshop/rest/WS_ChangeParentDetails?about
        return $this->doRequest('WS_ChangeParentDetails',$data);
    }

    public function addPaygatePayment($data)
    {
        // http://41.86.98.148/bookshop/rest/WS_PaygatePayment?about
        return $this->doRequest('WS_PaygatePayment',$data);
    }

    //public function getBooksByCatalogue($data)
  //  {
        // http://41.86.98.148/bookshop/rest/WS_GetBooksByCatalogue?about
  //      return $this->doRequest('WS_GetBooksByCatalogue',$data);
  //  }

//	public function getCatalogue($data)
 //   {
        // http://41.86.98.148/bookshop/rest/WS_GetCatalogue?about
 //       return $this->doRequest('WS_GetCatalogue',$data);
 //   }

    public function getBook($data)
    {
	 //http://41.86.98.148/bookshop/rest/WS_GetBook
	return $this->doRequest('WS_GetBook',$data);
    }
