...
class PaymentController extends App_Controller_Action
{
    ...
    public function cartAction()
    {
        ...
        $data = array(
        	...
        	'AMOUNT'	       => $model->getTotal($cart['id']) * 100,
			'CURRENCY'	       => 'ZAR',
    ...
    public function responseAction()
    {
        ...
        if ((int)$data['TRANSACTION_STATUS'] === 1) {
            ...
            if ($type === 'order') {
                ...
                $this->_helper->flashMessenger(array('success' => $this->translate('Your online payment has been processed successfully. Please allow 72 hours for the payment to reflect on your account.')));
