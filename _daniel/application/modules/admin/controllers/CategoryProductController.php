...
class Admin_CategoryProductController extends App_Controller_Admin
{

    public function init()
    {
        $this->model = new App_Model_CategoryProduct();
    }
    ...
    public function listAction()
    {
        ...
        $this->view->follow = $depth + 1 >= $depth_max ? false : true;
    }
    ...
    public function addAction()
    {
        ...
        $form  	 = new Admin_Form_CategoryProduct();
            ...
            if ($form->isValid($data)) {
                ...
                if (true === $result) {
                    ...
                    if (!$item) {
                        ...
                        $this->_helper->redirector('index', null, null, array('parent' => $form->getValue('parent') ? $form->getValue('parent') :  null));
        ...
        $this->renderScript('category-product/form.phtml');
