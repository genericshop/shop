...
class App_Service_Rest 
{
    ...
    //Production: http://154.0.163.97:81/rest/

    protected $_host = 'http://154.0.163.97:81/rest/';
    protected $_uri  = null;
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetAccountDetails?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetMyBalance?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_RegisterParentAccount?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_RegisterStudentAccount?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_ChangeParentDetails?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_ChangeStudentDetails?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_AddStudentToParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_LinkExistingStudentToParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetChildrenForParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetChildForParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetAllSubjectsByStudent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetStudentGrade?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_AddSubjectToStudent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_RemoveStudentSubject?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_LoginStoreAccount?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_ForgotPassword?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_ChangePassword?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetCatalogue?about
        return $this->doRequest('WS_GetCatalogue');
    }
    
    public function getBooksByCatalogue()
    {
        // http://154.0.163.97:81/rest/WS_GetBooksByCatalogue?about
    ...
    */
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetEBooks?about
        return $this->doRequest('WS_GetEBooks');
    }
    
    public function getBooks()
    {
        // http://154.0.163.97:81/rest/WS_GetBooks?about
        return $this->doRequest('WS_GetBooks');
    }
    
    public function getBook($isbn)
    {
        // http://154.0.163.97:81/rest/WS_GetBook?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetCatagories?about
        return $this->doRequest('WS_GetCatagories?StoreID=' . $this->store_id);
    }    
    
    public function getSubCategories($category_id)
    {
        // http://154.0.163.97:81/rest/WS_GetSubCatagories?about
        return $this->doRequest('WS_GetSubCatagories?StoreID=' . $this->store_id . '&CatagoryID=' . $category_id);
    }
    
    public function getAllProducts()
    {
        // http://154.0.163.97:81/rest/WS_GetAllProducts?about
        return $this->doRequest('WS_GetAllGrades');
    }
    
    public function getAllProductsByCategory($id)
    {
        // http://154.0.163.97:81/rest/WS_GetAllProductsByCatagory?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetAllProductsBySubCatagory?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetPriceListDetails?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetPriceListItemDetails?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetBuyBackBookPrices?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetTransactions?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetOrderDetails?about
        return $this->doRequest('WS_GetOrderDetails?StoreID=' . $this->store_id . '&OrderRef=' . $reference);
    }
    
    public function createOrder($data)
    {
        // http://154.0.163.97:81/rest/WS_CreateOrder?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_CreateOrderItem?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_PaygatePayment?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_CheckOrderStatus?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_PreviousOrdersByParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_PreviousOrderItemsByParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_PreviousOrdersByChild?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetMyBooksParent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_GetMyBooksStudent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_UpdateLinkStudent?about
    ...
    {
        // http://154.0.163.97:81/rest/WS_LogErrors?about
